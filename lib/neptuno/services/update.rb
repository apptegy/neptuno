...
module Neptuno
  module Services
    ...
    class Update < Neptuno::CLI::Base
      ...
      option :main, type: :boolean, default: false, desc: "Keep service on main/master after pull. Uncommited changes are stashed as 'neptuno_stash'"
